...
$execute if score entitynum dfl_scoreboard matches $(num).. run tellraw @a [{"text":"[DFL] 实体过多，已清除","color":"gray","italic":true},{"score":{"name":"entitynum","objective":"dfl_scoreboard"},"color":"red"},{"text":"个实体","color":"gray","italic":true}]
